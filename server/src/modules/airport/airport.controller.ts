...
export class AirportController {
  ...
  @ApiParam({
    name: 'amount',
    example: 5,
    description: 'The amount of airpots to be returned',
    required: false,
  })
  ...
  @ApiOperation({
    summary:
      'Search for airports by a given text. Returns the airport if it contains the given text in country, state, city or name property.',
  })
  @ApiParam({
    name: 'text',
